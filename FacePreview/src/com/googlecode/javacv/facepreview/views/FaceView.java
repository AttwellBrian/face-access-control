...
public class FaceView extends View implements Camera.PreviewCallback {
    ...
    // See usage http://vaohm.googlecode.com/svn-history/r29/trunk/Javacvtest/src/ImageProcessor.java
    ...
    protected void processImage(byte[] data, int width, int height) {
        ...
        backgroundSubtractor.apply(grayImage, foreground, -1);
		...
		faces = cvHaarDetectObjects(grayImage, classifier, storage, 1.1, 3, CV_HAAR_DO_CANNY_PRUNING); //note that I perform redundant calls to this. I later call this again inside the predictor
